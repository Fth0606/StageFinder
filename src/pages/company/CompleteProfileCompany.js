...
const CompleteProfileCompany = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (formData.description.length < 50) {
      setValidationError('La description doit contenir au moins 50 caractères');
      return;
    }
    ...
    if (result.type === 'user/updateProfile/fulfilled') {
      ...
      setValidationError('Erreur lors de la sauvegarde du profil');
    }
  };
              ...
              <Form onSubmit={handleSubmit}>
                ...
                <Form.Group className="mb-4">
                  ...
                  <Form.Control
                    ...
                    onChange={handleChange}
                    placeholder="Décrivez votre entreprise, sa mission, ses valeurs, son domaine d'expertise... (minimum 50 caractères)"
                    required
                    style={{ borderRadius: '10px' }}
                  />
                  <Form.Text className="text-muted">
