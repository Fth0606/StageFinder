...
const AdminUsers = () => {
  ...
  const getUserTypeBadge = (type) => {
    if (type === 'student') return { bg: 'primary', icon: FaUserGraduate, text: 'Étudiant' };
    if (type === 'company') return { bg: 'success', icon: FaUserTie, text: 'Entreprise' };
            ...
            <Table responsive hover>
              ...
              <tbody>
                {filteredUsers.map((user) => {
                  const typeInfo = getUserTypeBadge(user.userType);
                  ...
                  return (
                    <tr key={user.id}>
                      ...
                      <td>{user.email}</td>
                      <td>
                        <small>{new Date(user.createdAt).toLocaleDateString('fr-FR')}</small>
                      </td>
                      <td>
