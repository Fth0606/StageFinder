...
const AdminDashboard = () => {
  ...
  const { stats, recentActivities, isLoading } = useSelector((state) => state.admin);
  ...
  const mockChartData = [
    { name: 'Jan', stages: 40, users: 24, applications: 140 },
    { name: 'Fév', stages: 52, users: 38, applications: 198 },
    { name: 'Mar', stages: 61, users: 45, applications: 245 },
    { name: 'Avr', stages: 73, users: 52, applications: 289 },
    { name: 'Mai', stages: 89, users: 67, applications: 356 },
    { name: 'Juin', stages: 95, users: 78, applications: 412 },
  ];
  ...
  return (
    <Container fluid className="py-5">
      <div className="mb-4">
        ...
        <p className="text-muted">Vue d'ensemble de la plateforme Stage Finder</p>
      </div>
      ...
      <Row className="mb-4">
        ...
        <Col md={3}>
          <Card style={{
            ...
            color: 'white',
            boxShadow: '0 5px 20px rgba(0,200,83,0.3)'
          }}>
            <Card.Body>
              <div className="d-flex justify-content-between align-items-center">
                <div>
        ...
        <Col md={3}>
          <Card style={{
            ...
            color: 'white',
            boxShadow: '0 5px 20px rgba(255,167,38,0.3)'
          }}>
            <Card.Body>
              <div className="d-flex justify-content-between align-items-center">
                <div>
        ...
        <Col md={3}>
          <Card style={{
            ...
            color: 'white',
            boxShadow: '0 5px 20px rgba(156,39,176,0.3)'
          }}>
            <Card.Body>
              <div className="d-flex justify-content-between align-items-center">
                <div>
                  ...
                  <small style={{ opacity: 0.8 }}>
                    +{stats?.applicationsToday || 0} aujourd'hui
                  </small>
                </div>
                ...
                <div key={index} className="mb-3 pb-3" style={{ borderBottom: '1px solid #e9ecef' }}>
                  <div className="d-flex align-items-start">
                    <div className="me-3">
                      ...
                      {activity.type === 'stage' && <FaBriefcase className="text-success" />}
